...
namespace MTL {
	...
	namespace details {
		...
		class derives<void(T, Args...)> : public T, derives<void(Args...)>
		{};

		template< class T, class I, class ... Args>
		class derives<void(of<T, I>, Args...)> : public derives<void(Args...)>
		{};
	...
	template<class T, class I, class ... Args>
	class implements<T(I, Args...)> : public details::derives<void(I, Args...)>
	{
	public:
	...
	template<class T, class I, class ... Args>
	class implements<aggregatable<T>(I, Args...)> :public details::derives<void(I, Args...)>
	{
